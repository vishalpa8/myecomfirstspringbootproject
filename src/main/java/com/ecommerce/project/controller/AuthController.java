...
public class AuthController {
    ...
    public ResponseEntity<?> getUserDetails(Authentication authentication) {
        if (authentication == null) {
            return new ResponseEntity<>(new MessageResponse("you are not authorized to use!"), HttpStatus.UNAUTHORIZED);
        }
        UserDetailsImp userDetails = (UserDetailsImp) authentication.getPrincipal();
    ...
    public ResponseEntity<?> signOutUser(Authentication authentication) {
        if (authentication == null) {
            return new ResponseEntity<>(new MessageResponse("you are already signed out!"), HttpStatus.OK);
        }
        ResponseCookie cookie = jwtUtils.getCleanJwtCookie();
        return ResponseEntity.ok().header(HttpHeaders.SET_COOKIE,
                cookie.toString()).body(new MessageResponse("You've signed out!"));
    }
}
